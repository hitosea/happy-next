    ...
    switch (id) {
        case 'anthropic':
            return {
                ...
                compatibility: { claude: true, codex: false, gemini: false, qoder: false },
                isBuiltIn: true,
                createdAt: Date.now(),
                updatedAt: Date.now(),
                version: '1.0.0',
        ...
        case 'openai':
            return {
                ...
                compatibility: { claude: false, codex: true, gemini: false, qoder: false },
                isBuiltIn: true,
                createdAt: Date.now(),
                updatedAt: Date.now(),
                version: '1.0.0',
        ...
        case 'google-ai':
            ...
            return {
                ...
                defaultPermissionMode: 'default',
                compatibility: { claude: false, codex: false, gemini: true, qoder: false },
                isBuiltIn: true,
                createdAt: Date.now(),
                updatedAt: Date.now(),
                version: '1.0.0',
