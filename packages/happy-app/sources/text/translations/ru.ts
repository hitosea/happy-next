...
export const ru: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        qoderSessionIdCopied: 'ID сессии Qoder скопирован в буфер обмена',
    ...
    wizard: {
        ...
        installQoder: 'Установите CLI Qoder, если он доступен',
        viewInstallGuide: 'View Installation Guide →',
        viewGeminiDocs: 'View Gemini Docs →',
        viewQoderDocs: 'Открыть документацию Qoder →',
        add: 'Add',
        duplicate: 'Duplicate',
        delete: 'Delete',
        ...
        permQoderDefaultDesc: 'Запрашивать подтверждение',
        permQoderAutoDesc: 'Выполняется автоматически с проверками безопасности',
        permQoderAcceptEditsDesc: 'Автоматически принимает правки файлов',
        permQoderBypassDesc: 'Пропускает проверки разрешений',
        permQoderDontAskDesc: 'Никогда не запрашивает подтверждение',
