...
export const ja: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        qoderSessionIdCopied: 'Qoder セッション ID をクリップボードにコピーしました',
    ...
    wizard: {
        ...
        installQoder: 'Qoder CLI をインストール（利用可能な場合）',
        viewInstallGuide: 'インストールガイドを見る →',
        viewGeminiDocs: 'Gemini ドキュメントを見る →',
        viewQoderDocs: 'Qoder ドキュメントを見る →',
        add: '追加',
        duplicate: '複製',
        delete: '削除',
        ...
        permQoderDefaultDesc: '承認を求めます',
        permQoderAutoDesc: '安全チェック付きで自動実行',
        permQoderAcceptEditsDesc: 'ファイルの編集を自動的に承認',
        permQoderBypassDesc: '権限チェックをスキップ',
        permQoderDontAskDesc: '承認を求めません',
