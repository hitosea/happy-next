...
export const zhHant: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        qoderSessionIdCopied: 'Qoder 工作階段 ID 已複製到剪貼簿',
    ...
    wizard: {
        ...
        installQoder: '如可用，請安裝 Qoder CLI',
        viewInstallGuide: '檢視安裝指南 →',
        viewGeminiDocs: '檢視 Gemini 文件 →',
        viewQoderDocs: '檢視 Qoder 文件 →',
        add: '新增',
        duplicate: '複製',
        delete: '刪除',
        ...
        permQoderDefaultDesc: '操作前請求批准',
        permQoderAutoDesc: '帶安全檢查的自動執行',
        permQoderAcceptEditsDesc: '自動接受檔案編輯',
        permQoderBypassDesc: '跳過權限檢查',
        permQoderDontAskDesc: '從不請求批准',
