...
export const pt: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        qoderSessionId: 'ID da sessão Qoder',
        qoderSessionIdCopied: 'ID da sessão Qoder copiado para a área de transferência',
        failedToCopyQoderSessionId: 'Falha ao copiar ID da sessão Qoder',
    ...
    wizard: {
        ...
        installQoder: 'Instale a CLI do Qoder se estiver disponível',
        viewInstallGuide: 'View Installation Guide →',
        viewGeminiDocs: 'View Gemini Docs →',
        viewQoderDocs: 'Ver a documentação do Qoder →',
        add: 'Add',
        duplicate: 'Duplicate',
        delete: 'Delete',
        ...
        permQoderDefaultDesc: 'Solicitar aprovação',
        permQoderAutoDesc: 'Executa automaticamente com verificações de segurança',
        permQoderAcceptEditsDesc: 'Aceita edições de arquivos automaticamente',
        permQoderBypassDesc: 'Ignora as verificações de permissão',
        permQoderDontAskDesc: 'Nunca solicita aprovação',
