...
export const zhHans: TranslationStructure = {
    ...
    sessionInfo: {
        ...
        qoderSessionIdCopied: 'Qoder 会话 ID 已复制到剪贴板',
    ...
    wizard: {
        ...
        installQoder: '如可用，请安装 Qoder CLI',
        viewInstallGuide: '查看安装指南 →',
        viewGeminiDocs: '查看 Gemini 文档 →',
        viewQoderDocs: '查看 Qoder 文档 →',
        add: '添加',
        duplicate: '复制',
        delete: '删除',
        ...
        permQoderDefaultDesc: '操作前请求批准',
        permQoderAutoDesc: '带安全检查的自动执行',
        permQoderAcceptEditsDesc: '自动接受文件编辑',
        permQoderBypassDesc: '跳过权限检查',
        permQoderDontAskDesc: '从不请求批准',
