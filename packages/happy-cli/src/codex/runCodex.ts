...
export async function runCodex(opts: {
    ...
    // Keep Happy's remote autocomplete aligned with Codex Desktop/CLI skill discovery.
    // Codex can pick up new skills during a session (for example after $skill-installer),
    // so periodically rescan, but only write metadata when the skill list changed.
